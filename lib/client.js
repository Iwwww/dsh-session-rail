...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CSS = [
			...
			".dsh-rail-sessions__project{box-sizing:border-box;display:flex;align-items:center;gap:6px;width:100%;padding:6px 8px;border:0;border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary,inherit);font:inherit;text-align:left;cursor:pointer}",
			...
			".dsh-rail-sessions__chat{box-sizing:border-box;display:flex;align-items:center;gap:6px;width:100%;padding:5px 8px 5px 22px;border:0;border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary,inherit);font:inherit;text-align:left;cursor:pointer}",
